package com.harvey.experiment.delaunay.voronoi;


import com.harvey.experiment.delaunay.geom.Point;
import com.harvey.experiment.delaunay.geom.Rectangle;

import com.harvey.experiment.delaunay.voronoi.nodename.as3delaunay.LineSegment;
import com.harvey.experiment.delaunay.voronoi.nodename.as3delaunay.Voronoi;
...
public abstract class VoronoiGraph {
    ...
    private void buildGraph(Voronoi v) {
        ...
        final ArrayList<com.harvey.experiment.delaunay.voronoi.nodename.as3delaunay.Edge> libedges = v.edges();
        final HashMap<Integer, Corner> pointCornerMap = new HashMap();

        for (com.harvey.experiment.delaunay.voronoi.nodename.as3delaunay.Edge libedge : libedges) {
